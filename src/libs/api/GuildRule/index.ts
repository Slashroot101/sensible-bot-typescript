...
export const updateGuildRule = async (guildId: number, ruleId: number, props: GuildRuleUpsertRequest): Promise<GuildRuleUpsertResponse> => {
...
export const getDiscordRuleByRuleAction = async (ruleId: number, actionId: number): Promise<GuildRuleQueryResponse> => {
